...
withBlog :: AppConfig DefaultEnv () -> Logger -> (Application -> IO ()) -> IO ()
withBlog conf logger f = do
    s <- staticSite
...
withDevelAppPort = toDyn $ defaultDevelApp withBlog