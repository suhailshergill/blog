...
, fast-logger, friendly-time, hakyll, hamlet, hjsmin, http-conduit
, http-types, monad-control, monad-logger, mtl, old-locale
, persistent, persistent-postgresql, process, resourcet, safe
, shake, shakespeare-css, shakespeare-js, shakespeare-text, stdenv
...
mkDerivation {
  ...
  buildDepends = [
    ...
    containers data-default directory fast-logger friendly-time hakyll
    hamlet hjsmin http-conduit http-types monad-control monad-logger
    mtl old-locale persistent persistent-postgresql process resourcet
    safe shake shakespeare-css shakespeare-js shakespeare-text
    template-haskell text time transformers wai wai-extra warp yaml
    yesod yesod-auth yesod-core yesod-default yesod-form yesod-newsfeed
    yesod-paginator yesod-platform yesod-static yesod-test
  ];
